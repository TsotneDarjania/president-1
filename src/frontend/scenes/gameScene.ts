...
export default class GameScene extends Phaser.Scene {
  ...
  addPlayer() {
    this.player = new Player(
      this,
      GameConfig.player.positions.startPosition_X,
      GameConfig.player.positions.startPosition_Y
    );
  ...
  addRoad() {
    this.road = this.add
      .tileSprite(0, 790, this.gameSceneWidth, 210, "road")
      .setScale(0.6)
      .setOrigin(0, 0);
    this.physics.add.staticGroup(this.road);

    this.add
      .image(0, 790, "hideLine")
